...
function loadStatsPage(){
		...
		{//Outer for loop iterates over each row
			...
			var opposeName = table.rows[row_counter].cells[1].innerHTML;
			var CUscore = table.rows[row_counter].cells[2].innerHTML;
			var opposeScore =table.rows[row_counter].cells[3].innerHTML;

			if(CUscore < opposeScore){
				//console.log(123)
				table.rows[row_counter].cells[4].innerHTML = opposeName;
				lose++;

			}

			else if(opposeScore < CUscore){
				//console.log(456)
				...
				//Increase the cell's value by 2
...
function loadPlayersPage(){
	...
	for(i = 0; i<players.length; i++){
		text += '<a href = "#" onclick = "switchPlayers('+i+')" class="dropdown-item">'+players[i].name+ '</a>';
